...
<div id="primary" class="content-area">
	<main id="main" class="site-main shop_type_archive" role="main">
		...
		<?php
		if ( have_posts() ):
			$arrTerm = array( 'osaka', 'hyogo', 'siga', 'wakayama', 'gifu', 'aichi', 'fukui', 'okayama', 'hiroshima', 'yamaguchi', 'kagawa', 'kouchi' );
		...
		<div class="kind_wrap" id="area04">
			<h2 class="kind_title"><span>和歌山</span><a class="to-top" href=""><i class="fa fa-angle-up" aria-hidden="true"></i></a></h2>
