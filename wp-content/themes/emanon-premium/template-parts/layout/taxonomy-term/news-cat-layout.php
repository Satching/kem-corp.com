<?php
/**
 * Template part for layout in taxonomy-news-cat.php
 *
 * @since 1.0.0
 * @package Emanon Premium
 */

$header_style        = get_theme_mod( 'news_taxonomy_header_style', 'taxonomy_term_header_standard' );
$breadcrumb_position = get_theme_mod( 'archive_news_breadcrumb_position', 'content_top' );
...
<div id="contents">
	...
	<div class="l-content">
		...
		<div class="l-content__inner">
			...
			<?php
				get_template_part( 'template-parts/content/taxonomy-term/content-news-term' );
			?>
			</main>
			<?php
				if ( 'one-col' !== $col ) {
