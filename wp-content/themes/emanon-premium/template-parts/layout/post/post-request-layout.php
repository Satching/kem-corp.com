<?php
/**
 * Template part for layout in single-request.php
 *
 * @since 1.0.0
 * @package Emanon Premium
 */

$header_style        = get_theme_mod( 'post_request_header_style', 'featured_standard' );
$news                = get_theme_mod( 'display_header_news_' . DEVICE );
$breadcrumb_position = get_theme_mod( 'post_request_breadcrumb_position', 'content_top' );
$col                 = get_theme_mod( 'post_request_layout','two-r-col' );
$share_button_sticky = get_theme_mod( 'display_share_button_sticky_post_request' );
	...
	<div class="l-content">
		...
		<div class="l-content__inner">
			...
			<main class="l-content__main<?php echo esc_attr( $class_featured ); ?>">
				<?php get_template_part( 'template-parts/content/post/content-request' ); ?>
			</main>
			<?php
				get_sidebar( 'request' );
			?>
